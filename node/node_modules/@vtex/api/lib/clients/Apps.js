...
class Apps extends HttpClient_1.InfraClient {
    constructor(context, options) {
        ...
        this.getAppsMetaInfos = async (filter) => {
        ...
        this.resolveDependenciesWithManifest = (manifest, filter = '') => {
            ...
            return this.http.post(this.routes.ResolveDependenciesWithManifest(), manifest, { params, paramsSerializer, metric });
        };
